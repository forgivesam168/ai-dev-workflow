...
3. **Financial-Grade Security**: Identify language-specific security risks, enforce threat modeling, and ensure regulatory compliance (GDPR, PCI-DSS).
...
→ For ADR format and design methodology, see skills/brainstorming/